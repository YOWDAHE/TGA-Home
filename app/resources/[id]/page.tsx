...
export async function generateMetadata({ params }: DocumentPageProps): Promise<Metadata> {
	try {
		...
		return {
			title: title,
			description: description || `Download ${title} - Legal document from TGA Law Group. File size: ${formatFileSize(file_size)}`,
			keywords: [
				'legal document',
				'legal resource',
				'download',
			...
			openGraph: {
				...
				description: description || `Download ${title} - Legal document from TGA Law Group`,
