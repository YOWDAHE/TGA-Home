...
export const metadata: Metadata = {
  title: 'Legal Services for Diaspora Ethiopians | Ethiopian Diaspora Legal Help | TGA Law Group',
			...
			<div className="min-h-screen bg-gray-50">
					...
					<div className="container mx-auto px-4">
						<div className="max-w-4xl mx-auto text-center">
							<h2 className="text-3xl font-bold mb-8">
								Why Choose TGA Law Group for Diaspora Legal Services?
							</h2>
							...
							<div className="grid md:grid-cols-2 gap-8">
								<div className="bg-gray-50 p-6 rounded-lg">
									<p className="text-gray-600 mb-4 italic">
										"TGA Law Group provided excellent legal services for my property
				...
				<section className="bg-teal-600 text-white py-16">
					<div className="container mx-auto px-4 text-center">
						...
						<p className="text-xl mb-8">
							Contact TGA Law Group for comprehensive Ethiopian diaspora legal help
						</p>
